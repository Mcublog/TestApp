...
void prepare(const string& workdir, const string& tested, const string& result)
{
...
int main(int argc, char ** argv)
{
    ...
    std::cout << "ErrorsOnly," << err_only << '\n';
    sa::SawAnalyzingFunc::test_param_out(tp);

    prepare(WORK_DIR_NAME, TESTED_DIR_NAME, RESULT_DIR_NAME);
